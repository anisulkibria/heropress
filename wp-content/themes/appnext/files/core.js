jQuery(document).ready(function ($) {
    ...
    if ($('.widget-box-blog').length) {
        $.ajax({
            url: 'https://ajax.googleapis.com/ajax/services/feed/load?v=1.0&num=-1&callback=?&q=' + encodeURIComponent('https://blog.appnext.com/?feed=rss2'),
            dataType: 'json',
    ...
    $('.blue-love').on('click', function () {
        $('.pop-up').show(100, function () {
            $(frame).attr('src', '//selfservice.appnext.com/account/register1.aspx').load(function () {
